...
from prefill_evals.config import load_config, EvalConfig, ModelBasedResponseGraderConfig, StringMatchGraderConfig, BinaryChoiceGraderConfig, MultiturnEvaluatorConfig, NumberRangeGraderConfig
...
from prefill_evals.autograders import ModelBasedResponseGrader, StringMatchGrader, BinaryChoiceGrader, NumberRangeGrader
...
async def evaluate_model_scenario_pair(
    ...
    for grader_config in config.autograders:
        ...
        elif isinstance(grader_config, NumberRangeGraderConfig):
            graders.append(NumberRangeGrader(grader_config))
        else:
